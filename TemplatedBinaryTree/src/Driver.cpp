...
//  Driver.cpp
//
//  This file tests your functionality against a defined set of unit tests. Consider these tests to be a clarification of the problem, should any inconsistencies occur.
//  You are supposted to implement the class that inherits from AbstractBinarySearchTree and can be found is called BinarySearchTreeImpl.h
//  AbstractBinarySearchTree is a abstract class and this file will not link without it's implementation
//
...
inline void call_assert(bool expr, const char* file_name, int line_no, const char* content, const char* func_name)
{
    if(!expr) {
